...
- `slice`: produce a bounded component summary with evidence, claims, edges, unknowns, and optional glob/path exclusions for noisy supplied files (including Python/JS/TS/PHP/Go/Ruby/Rust code-entry and dependency/call extraction plus Python/JS/TS/PHP/Java/C# route/interface extraction)
